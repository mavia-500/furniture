  ...
  const mattressData = [
    {
      ...
      details: [
        ...
        },
        {
          ...
          sevenInch: {
            thickness: `7"`,
            size_price_twin: { size: "twin/single", price: 95 },
            size_price_double: { size: "double/full", price: 150 },
            size_price_queen: { size: "queen", price: 185 },
            size_price_king: { size: "king", price: 230 },
          },
        },
        {
      ...
      details: [
        {
          ...
          tenInch: {
            thickness: `10"`,
            size_price_twin: { size: "twin/single", price: 150 },
            size_price_double: { size: "double/full", price: 170 },
            size_price_queen: { size: "queen", price: 200 },
            size_price_king: { size: "king", price: 265 },
          },
          tewelveInch: {
            thickness: `12"`,
            size_price_twin: { size: "twin/single", price: 220 },
            size_price_double: { size: "double/full", price: 270 },
            size_price_queen: { size: "queen", price: 365 },
            size_price_king: { size: "king", price: 395 },
          },
        },
        {
...
`,
          nineInch: {
            thickness: `9"`,
            size_price_twin: { size: "twin/single", price: 155 },
            size_price_double: { size: "double/full", price: 210 },
            size_price_queen: { size: "queen", price: 265 },
            size_price_king: { size: "king", price: 285 },
          },
        },
        {
          ...
          tenInch: {
            thickness: `10"`,
            size_price_twin: { size: "twin/single", price: 165 },
            size_price_double: { size: "double/full", price: 235 },
            size_price_queen: { size: "queen", price: 285 },
            size_price_king: { size: "king", price: 330 },
          },
          tewelveInch: {
            thickness: `12"`,
            size_price_twin: { size: "twin/single", price: 240 },
            size_price_double: { size: "double/full", price: 340 },
            size_price_queen: { size: "queen", price: 395 },
            size_price_king: { size: "king", price: 495 },
          },
        },
      ],
    },
      ...
      details: [
        {
          ...
          tewelveInch: {
            ...
            size_price_queen: { size: "queen", price: 430 },
      ...
      details: [
        {
          ...
          eightInch: {
            thickness: `8"`,
            size_price_twin: { size: "twin/single", price: 160 },
            size_price_double: { size: "double/full", price: 240 },
            size_price_queen: { size: "queen", price: 265 },
            size_price_king: { size: "king", price: 330 },
          },
          tewelveInch: {
            thickness: `12"`,
            size_price_double: { size: "double/full", price: 430 },
            size_price_queen: { size: "queen", price: 495 },
